...
| --------- | ------------------------ | --------------------- | ----------- |
| Viktoriia | Set up components        | scrummaster          | Placeholder |
| Maria     | Set up components, scrummaster, discussed temporary API   |  Work on steg-item component      | None |
| Andryan   | Choose which components to work on              | Placeholder           | Placeholder |
| Veronica  | Set up Vite projects to work with components | Placeholder | Placeholder |
